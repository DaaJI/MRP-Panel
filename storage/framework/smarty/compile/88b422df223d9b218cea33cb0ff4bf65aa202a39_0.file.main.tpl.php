<?php
/* Smarty version 3.1.34-dev-7, created on 2020-03-31 18:31:30
  from '/www/wwwroot/preview.1/resources/views/material/user/main.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_5e831c0205e8b6_10542538',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '88b422df223d9b218cea33cb0ff4bf65aa202a39' => 
    array (
      0 => '/www/wwwroot/preview.1/resources/views/material/user/main.tpl',
      1 => 1585650426,
      2 => 'file',
    ),
  ),
...
function content_5e831c0205e8b6_10542538 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="zh-cn">
...
-->
	        <?php if ($_smarty_tpl->tpl_vars['user']->value->isTech() || $_smarty_tpl->tpl_vars['user']->value->isSales() || $_smarty_tpl->tpl_vars['user']->value->isSu()) {?>
                        <li>
                            <a href="/admin/product"><i class="icon icon-lg">shop</i>&nbsp;产品设计物料清单</a>
                        </li>
                <?php }?>

	        <?php if ($_smarty_tpl->tpl_vars['user']->value->isWHAdmin() || $_smarty_tpl->tpl_vars['user']->value->isTech() || $_smarty_tpl->tpl_vars['user']->value->isDepo()) {?>
                        <li>
                            <a href="/admin/depository"><i class="icon icon-lg">account_balance</i>&nbsp;仓库库存</a>
                        </li>
                <?php }?>

	        <?php if ($_smarty_tpl->tpl_vars['user']->value->isWHAdmin()) {?>
                        <li>
