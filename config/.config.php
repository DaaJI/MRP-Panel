...
//基本设置--------------------------------------------------------------------------------------------
$System_Config['key'] = '114514';						//!!! 瞎 jb 修改此key为随机字符串确保网站安全 !!!
$System_Config['debug'] =  false;								//正式环境请确保为 false
$System_Config['appName'] = '广东新雅空调设备有限公司';							//站点名称
$System_Config['baseUrl'] = 'http://47.240.80.51';					//站点地址
...
$System_Config['db_host'] = '47.240.80.51:53306';						//数据库地址
...
$System_Config['smtp_username'] = 'hehouzhu@gmail.com';
$System_Config['smtp_port'] = '465';
$System_Config['smtp_name'] = 'Houzhu He';
$System_Config['smtp_sender'] = 'Houzhu He';
$System_Config['smtp_passsword'] = '15015828500zzz';
...
$System_Config['user_class_default']='1';					//用户注册等级，在注册时设置。
...
$System_Config['port_price_specify']='5';		//用户指明钦定端口所需要的价格，价格小于0时视为不开放购买

#高级
$System_Config['class_expire_reset_traffic']='0.05';		//等级到期时重置为的流量值，单位GB，小于0时不重置
$System_Config['account_expire_delete_days']='-1';		//账户到期几天之后会删除账户，小于0时不删除
$System_Config['enable_kill']='false';					//是否允许用户注销账户
$System_Config['notify_limit_mode'] = 'per';			//false为关闭，per为按照百分比提醒，mb为按照固定剩余流量提醒
$System_Config['notify_limit_value'] = '10';			//当上一项为per时，此处填写百分比；当上一项为mb时，此处填写流量
...
$System_Config['useScFtqq'] = 'true';		//是否开启工单Server酱提醒
$System_Config['ScFtqq_SCKEY'] = 'SCU4087T98d424ad8e9b08d0a5d6437c3bf557f95837760c324a6';	//请填写您在Server酱获取的SCKEY  请仔细检查勿粘贴错
...
$System_Config['detect_gfw_port']='60022';												//所有节点服务器都打开的TCP端口，常用的为22（SSH端口）
