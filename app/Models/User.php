...
class User extends Model
{
    ...
    {
        return $this->attributes['is_su'];
    }

    public function isWHAdmin()
    {
        return $this->attributes['is_whadmin'];
    }

    public function isTech()
    {
        return $this->attributes['is_tech'];
    }

    public function isDepo()
    {
        return $this->attributes['is_depo'];
    }

    public function isSales()
    {
        return $this->attributes['is_sales'];
    }
